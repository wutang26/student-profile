...
<form method="POST" action="{{ route('staff.update', $staff->id) }}" class="form-container">
@csrf
@method('PUT')
    ...
    <div class="form-card">
        ...
        <div class="form-grid">
            <input type="text" name="first_name"  placeholder="First Name" value="{{ $staff->first_name }}" required>
            <input type="text" name="middle_name" placeholder="Middle Name"  value="{{ $staff->middle_name }}">
            <input type="text" name="last_name"  placeholder="Last Name" required  value="{{ $staff->last_name }}">
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-grid">
            <input type="text"  name="force_number" value="{{ $staff->force_number }}" placeholder="Service Number" required>
            <input type="text" name="rank" value="{{ $staff->rank }}" placeholder="Rank">
            <input type="text" name="department"  value="{{ $staff->department }}" placeholder="Department">
        </div>
    </div>
